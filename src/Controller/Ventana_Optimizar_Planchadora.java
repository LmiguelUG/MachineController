...
public class Ventana_Optimizar_Planchadora extends JFrame {
    
    // Variables de los componentes
    Planchadora planchadora;
           
    JPanel panel;
    JLabel LDL, LHL, LPM, LS, LCPM, LCPD, controller, LVMOD, LVMH, LVMD;
    ...
    public Ventana_Optimizar_Planchadora(Planchadora planchadora) {
    ...
    public void CreateComponents() {
        ...
        TFDL.setText(String.valueOf(planchadora.dias_laborales));
        
        TFHL   = new JTextField();
        TFHL.setBounds(180, 80, 150, 25);
        TFHL.setText(String.valueOf(planchadora.horas_laborales));
        
        TFPM   = new JTextField();
        TFPM.setBounds(180, 110, 150, 25);
        TFPM.setText(String.valueOf(planchadora.produccion_mensual));
        
        TFS    = new JTextField();
        TFS.setBounds(180, 140, 150, 25);
        TFS.setText(String.valueOf(planchadora.sueldo));
        
        TFVMOD = new JTextField();
        TFVMOD.setBounds(180, 170, 150, 25);
        TFVMOD.setText(String.valueOf(planchadora.valor_mano_obra_dia));
        
        TFVMH  = new JTextField();
        TFVMH.setBounds(180, 200, 150, 25);
        TFVMH.setText(String.valueOf(planchadora.valor_maquina_hora));
        
        TFVMD  = new JTextField();
        TFVMD.setBounds(180, 230, 150, 25);
        TFVMD.setText(String.valueOf(planchadora.valor_maquina_dia));
        
        TFCPD  = new JTextField();
        TFCPD.setBounds(180, 260, 150, 25);
        TFCPD.setText(String.valueOf(planchadora.costo_proceso_dia));
        
        TFCPM  = new JTextField();
        TFCPM.setBounds(180, 290, 150, 25);
        TFCPM.setText(String.valueOf(planchadora.costo_proceso_mes));
        
        controller = new  JLabel("OPTIMIZACIÓN PLANCHADORA");
