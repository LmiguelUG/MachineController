...
public class Ventana_Optimizar_Campanera extends JFrame {
    ...
    // Constructor de la clase, necesario para la creacion de objetos de esta clase
    public Ventana_Optimizar_Campanera(Campanera campanera) {
        
        this.campanera = campanera;
        
        // Propiedades de la ventana 
        this.setTitle("Automatización de Campanera");
    ...
    public void CreateComponents() {
        ...
        TFDL.setText(String.valueOf(campanera.dias_laborales));
        
        TFHL   = new JTextField();
        TFHL.setBounds(180, 80, 150, 25);
        TFHL.setText(String.valueOf(campanera.horas_laborales));
        
        TFPM   = new JTextField();
        TFPM.setBounds(180, 110, 150, 25);
        TFPM.setText(String.valueOf(campanera.produccion_mensual));
        
        TFS    = new JTextField();
        TFS.setBounds(180, 140, 150, 25);
        TFS.setText(String.valueOf(campanera.sueldo));
        
        TFVMOD = new JTextField();
        TFVMOD.setBounds(180, 170, 150, 25);
        TFVMOD.setText(String.valueOf(campanera.valor_mano_obra_dia));
        
        TFVMH  = new JTextField();
        TFVMH.setBounds(180, 200, 150, 25);
        TFVMH.setText(String.valueOf(campanera.valor_maquina_hora));
        
        TFVMD  = new JTextField();
        TFVMD.setBounds(180, 230, 150, 25);
        TFVMD.setText(String.valueOf(campanera.valor_maquina_dia));
        
        TFCPD  = new JTextField();
        TFCPD.setBounds(180, 260, 150, 25);
        TFCPD.setText(String.valueOf(campanera.costo_proceso_dia));
        
        TFCPM  = new JTextField();
        TFCPM.setBounds(180, 290, 150, 25);
        TFCPM.setText(String.valueOf(campanera.costo_proceso_mes));
        
        controller = new  JLabel("OPTIMIZACIÓN CAMPANERA");
    ...
    public void AddComponents () {
        ...
        panel.add(LDL);   panel.add(LCPM);   panel.add(LVMD);
        panel.add(LVMH);  panel.add(LVMOD);  panel.add(LS);
        panel.add(LPM);   panel.add(LHL);    panel.add(LCPD);
        panel.add(TFDL);  panel.add(TFCPM);  panel.add(TFVMD);
        panel.add(TFVMH); panel.add(TFVMOD); panel.add(TFS);
        panel.add(TFPM);  panel.add(TFHL);   panel.add(TFCPD);
        panel.add(btn_aceptar); panel.add(controller);
    }
